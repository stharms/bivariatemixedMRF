...
plot.r.w<- ggplot(filter(weakplot,ind=="rho"), aes(x=as.factor(modelno)))+geom_boxplot(aes(y=values))+
  geom_hline(yintercept=0.2, linetype="dashed", size=1.5) + labs(x="", y=expression(rho)) + ggtitle("Weak")+
  ylim(0,.75) + theme(axis.title.y = element_text(size=24, angle=0, vjust=0.5))
plot.ez.w<- ggplot(filter(weakplot,ind=="eta_z"), aes(x=as.factor(modelno)))+geom_boxplot(aes(y=values))+
  geom_hline(yintercept=0.3, linetype="dashed", size=1.5)+ labs(x="", y=expression(eta[z])) + ggtitle("Weak")+ylim(0,0.6)+
  theme(axis.title.y = element_text(size=24, angle=0, vjust=0.5))
plot.ey.w<- ggplot(filter(weakplot,ind=="eta_y"), aes(x=as.factor(modelno)))+geom_boxplot(aes(y=values))+
  geom_hline(yintercept=1, linetype="dashed", size=1.5)+ labs(x="", y=expression(eta[y])) + ggtitle("Weak")+ylim(-0.5,2.5)+
  theme(axis.title.y = element_text(size=24, angle=0, vjust=0.5))
plot.b0y.w<- ggplot(filter(weakplot,ind=="b0.y"), aes(x=as.factor(modelno)))+geom_boxplot(aes(y=values))+
  geom_hline(yintercept=-1, linetype="dashed", size=1.5)+ labs(x="", y=expression(beta["0y"])) + ggtitle("Weak")+ylim(-1.4,-0.5)+
  theme(axis.title.y = element_text(size=24, angle=0, vjust=0.5))
plot.b1y.w<- ggplot(filter(weakplot,ind=="b1.y"), aes(x=as.factor(modelno)))+geom_boxplot(aes(y=values))+
  geom_hline(yintercept=0.5, linetype="dashed", size=1.5)+ labs(x="", y=expression(beta["1y"])) + ggtitle("Weak")+ylim(0.25,0.7)+
  theme(axis.title.y = element_text(size=24, angle=0, vjust=0.5))
plot.b0z.w<- ggplot(filter(weakplot,ind=="b0.z"), aes(x=as.factor(modelno)))+geom_boxplot(aes(y=values))+
  geom_hline(yintercept=1, linetype="dashed", size=1.5)+ labs(x="", y=expression(beta["0z"])) + ggtitle("Weak")+ylim(0.7,1.3)+
  theme(axis.title.y = element_text(size=24, angle=0, vjust=0.5))
plot.b1z.w<- ggplot(filter(weakplot,ind=="b1.z"), aes(x=as.factor(modelno)))+geom_boxplot(aes(y=values))+
  geom_hline(yintercept=0.1, linetype="dashed", size=1.5)+ labs(x="", y=expression(beta["1z"])) + ggtitle("Weak")+ ylim(0.07,0.13)+
  theme(axis.title.y = element_text(size=24, angle=0, vjust=0.5))
plot.sig2.w<- ggplot(filter(weakplot,ind=="sigma2"), aes(x=as.factor(modelno)))+geom_boxplot(aes(y=values))+
...
plot.r.m<- ggplot(filter(modplot,ind=="rho"), aes(x=as.factor(modelno)))+geom_boxplot(aes(y=values))+
  geom_hline(yintercept=1, linetype="dashed", size=1.5) + labs(x="", y="") + ggtitle("Moderate")+ ylim(0,2)
plot.ez.m<- ggplot(filter(modplot,ind=="eta_z"), aes(x=as.factor(modelno)))+geom_boxplot(aes(y=values))+
  geom_hline(yintercept=0.3, linetype="dashed", size=1.5)+ labs(x="", y="") + ggtitle("Moderate")+ylim(0,0.6)
plot.ey.m<- ggplot(filter(modplot,ind=="eta_y"), aes(x=as.factor(modelno)))+geom_boxplot(aes(y=values))+
  geom_hline(yintercept=1, linetype="dashed", size=1.5)+ labs(x="", y="") + ggtitle("Moderate")+ylim(-0.5,3)
plot.b0y.m<- ggplot(filter(modplot,ind=="b0.y"), aes(x=as.factor(modelno)))+geom_boxplot(aes(y=values))+
  geom_hline(yintercept=-1, linetype="dashed", size=1.5)+ labs(x="", y="") + ggtitle("Moderate")+ylim(-1.5,-0.3)
plot.b1y.m<- ggplot(filter(modplot,ind=="b1.y"), aes(x=as.factor(modelno)))+geom_boxplot(aes(y=values))+
  geom_hline(yintercept=0.5, linetype="dashed", size=1.5)+ labs(x="", y="") + ggtitle("Moderate")+ylim(0.2,0.7)
plot.b0z.m<- ggplot(filter(modplot,ind=="b0.z"), aes(x=as.factor(modelno)))+geom_boxplot(aes(y=values))+
  geom_hline(yintercept=1, linetype="dashed", size=1.5)+ labs(x="", y="") + ggtitle("Moderate") +ylim(0.7,1.4)
plot.b1z.m<- ggplot(filter(modplot,ind=="b1.z",as.factor(modelno)!=2), aes(x=as.factor(modelno)))+geom_boxplot(aes(y=values))+
  geom_hline(yintercept=0.1, linetype="dashed", size=1.5)+ labs(x="", y="") + ggtitle("Moderate")+ ylim(0.07,0.13)
plot.sig2.m<- ggplot(filter(modplot,ind=="sigma2"), aes(x=as.factor(modelno)))+geom_boxplot(aes(y=values))+
...
plot.r.s<- ggplot(filter(strongplot,ind=="rho"), aes(x=as.factor(modelno)))+geom_boxplot(aes(y=values))+
  geom_hline(yintercept=0.5, linetype="dashed", size=1.5) + labs(x="", y="") + ggtitle("Strong")+ ylim(-1,2)
plot.ez.s<- ggplot(filter(strongplot,ind=="eta_z"), aes(x=as.factor(modelno)))+geom_boxplot(aes(y=values))+
  geom_hline(yintercept=0.9, linetype="dashed", size=1.5)+ labs(x="", y="") + ggtitle("Strong") + ylim(.5,1.1)
plot.ey.s<- ggplot(filter(strongplot,ind=="eta_y"), aes(x=as.factor(modelno)))+geom_boxplot(aes(y=values))+
  geom_hline(yintercept=3.5, linetype="dashed", size=1.5)+ labs(x="", y="") + ggtitle("Strong")+ ylim(0.8,7)
plot.b0y.s<- ggplot(filter(strongplot,ind=="b0.y"), aes(x=as.factor(modelno)))+geom_boxplot(aes(y=values))+
  geom_hline(yintercept=-1, linetype="dashed", size=1.5)+ labs(x="", y="") + ggtitle("Strong")+ ylim(1,3.5)
plot.b1y.s<- ggplot(filter(strongplot,ind=="b1.y"), aes(x=as.factor(modelno)))+geom_boxplot(aes(y=values))+
  geom_hline(yintercept=0.5, linetype="dashed", size=1.5)+ labs(x="", y="") + ggtitle("Strong")+ ylim(0,1)
plot.b0z.s<- ggplot(filter(strongplot,ind=="b0.z"), aes(x=as.factor(modelno)))+geom_boxplot(aes(y=values))+
  geom_hline(yintercept=1, linetype="dashed", size=1.5)+ labs(x="", y="") + ggtitle("Strong")+ ylim(0,6)
plot.b1z.s<- ggplot(filter(strongplot,ind=="b1.z"), aes(x=as.factor(modelno)))+geom_boxplot(aes(y=values))+
  geom_hline(yintercept=0.1, linetype="dashed", size=1.5)+ labs(x="", y="") + ggtitle("Strong")+ ylim(0.07,0.13)
plot.sig2.s<- ggplot(filter(strongplot,ind=="sigma2"), aes(x=as.factor(modelno)))+geom_boxplot(aes(y=values))+
